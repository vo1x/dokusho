			...
			<div className="w-full">
				<div className="flex flex-col items-center justify-center gap-4 rounded-md">
					...
					<div className="flex flex-col items-center gap-4">
						...
						<p className="line-clamp-2 text-[#747c88]">{mangaMeta.synopsis}</p>
						...
						<div className="flex items-center gap-4">
							...
							<button className="flex h-12 min-w-38 items-center justify-center gap-2 rounded-md bg-dokusho-button-secondary p-2 px-4 text-lg text-rosepine-moon-foam">
